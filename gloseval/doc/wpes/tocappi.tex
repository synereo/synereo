...
complex, as in the bank example above; Yee, for example, reports that a 90-man-hour
...
\noindent If we have that $P \models \pgfp{X}{\neg
...
here is to mediate between the closed-world and open-world forms of
