...
L.G. Meredith\\
  ...
  \affaddr{7329 39th Ave SW, Seattle, WA US}\\
...
the corresponding Hennessy-Milner logic suffices to capture the 
key notion of deniability.

The Curry-Howard isomorphism relates formal logic to type theory; it says 
that propositions are to types as proofs are to programs.  Hennessy-Milner
