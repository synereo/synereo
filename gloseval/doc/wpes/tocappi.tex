...
the \texttt{SpecialK} library available on \texttt{github}. This
library is already in use in industrial projects such as the Protunity
...
types. The first two author's work on this topic is generously support
