...
$\nameeq$, pronounced name-equivalence that is recursively related to
$\alpha$-equivalence and structural equivalence.
...
see the appendix \ref{sec:syntactic_substitution} or
...
purse is essentially a cell, the internal state of which is balance.
...
\section{Appendix: $\rho$-calculus substitution and sugar}

\subsection{Syntactic substitution}\label{sec:syntactic_substitution}
