...
\normalsize{ 
  ...
  profoundly deep and wide specialization so that even when claims are
  accompanied by detailed technical presentations and argumentations
  and even physical evidence, they may couched in a technical language
  that requires a significant investment with which to acquire
  facility, let alone master.
  ...
  mechanics) simply threw up their hands and published the paper
  unreviewed. They did this principally because of Girard's
  ...
  considerable and the old mechanisms of centralized governance (from
  ...
  of the violation of trust which can be used in the evaluation of
  ...
  addressing networks of interacting agency at arbitraty scale, such
