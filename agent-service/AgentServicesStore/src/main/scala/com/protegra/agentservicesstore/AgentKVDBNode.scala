...
package usage {
  ...
  with Serializable
  {
	...
	theEMTypes
      ...
      object AgentKVDBNodeFactory extends AgentKVDBNodeFactoryT with Serializable {	  
	def mkCache[ReqBody <: PersistedKVDBNodeRequest, RspBody <: PersistedKVDBNodeResponse]( here : URI ) : AgentKVDB[ReqBody,RspBody] = {
