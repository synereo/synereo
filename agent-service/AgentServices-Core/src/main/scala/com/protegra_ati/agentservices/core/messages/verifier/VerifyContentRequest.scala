...
case class VerifyContentRequest(override val ids: Identification, override val eventKey: EventKey, contentVerifier:ContentVerifier, value:String, claimingAgentCnxn: AgentCnxn) extends Message
with Request
