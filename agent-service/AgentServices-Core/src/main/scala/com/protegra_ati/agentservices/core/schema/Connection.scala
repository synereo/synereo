...
case class Connection(
  ...
  @BeanProperty var readCnxn: AgentCnxn,
  @BeanProperty var writeCnxn: AgentCnxn,
...
//  // TODO AgentCnxn will probably also will be refactored to string, or AgentCnxn will prowide toString method and also AgentCnxn.valueOf methods
//  def this(connectionType: String, alias: String, readCnxn: AgentCnxn, writeCnxn: AgentCnxn, autoApprove: String, behaviors: List[ String ]) = this(connectionType, alias, readCnxn, writeCnxn, autoApprove, behaviors, null)
//
  def this(
  _category: String,
