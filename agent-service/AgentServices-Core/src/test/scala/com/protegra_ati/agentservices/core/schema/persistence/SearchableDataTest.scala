...
class SearchableDataTest extends SpecificationWithJUnit
{
  ...
  "fields " should {
    ...
    "set firstname" in {
      val expected = "profile(data(" +"_," + FIELDS + "(firstName(\"John\"),lastName(_),description(_),emailAddress(_),country(_),region(_),city(_),postalCode(_),website(_),image(_))))"
    ...
    "set lastname" in {
      val expected = "profile(data(" +"_," + FIELDS + "(firstName(_),lastName(\"Adams\"),description(_),emailAddress(_),country(_),region(_),city(_),postalCode(_),website(_),image(_))))"
      val test: Profile = new Profile()
      test.lastName = "Adams"
    ...
    "set all wildcards" in {
      //val expected = "profile(data(_," + "fields(firstName(_),lastName(_),description(_),emailAddress(_),country(_),region(_),city(_),postalCode(_),website(_),image(_))))"
    ...
    "set locale" in {
      //val expected = "profile(data("  + KEYS + "(id(_),localeCode(\"en\"),recVerNum(_))," + "fields(firstName(_),lastName(_),description(_),emailAddress(_),country(_),region(_),city(_),postalCode(_),website(_),image(_))))"
