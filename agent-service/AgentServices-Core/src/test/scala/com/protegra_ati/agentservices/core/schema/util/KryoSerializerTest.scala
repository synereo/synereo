...
class KryoSerializerTest
  extends JUnit4(KryoSerializerTestSpecs)

object KryoSerializerTestSpecsRunner
  extends ConsoleRunner(KryoSerializerTestSpecs)

object KryoSerializerTestSpecs extends Specification with Timeouts
{

  KryoSerializerTestDataInitializer.setup(this)
    ...
    "serialize and deserialize different mock objects" in {
      ...
      deserializedMockRequest match {
        case x: MockCreateInvitationRequest => {
          ...
          //          x.someTest match {
          //            case None => fail("can't deserialize, none instead of string value")
          //            case Some(role) => {
      ...
      val deserializedAgentCnxn = KryoSerializerTestDataInitializer.deserialize[ MockAgentCnxn ](new File("agentCnxn.kryobin"))
      ...
      val deserializedAgentCnxn1 = KryoSerializerTestDataInitializer.deserialize[ MockAgentCnxn ](new File("agentCnxn.kryobin"))
      ...
      val deserializedAgentCnxn2 = KryoSerializerTestDataInitializer.deserialize[ MockAgentCnxn ](new File("agentCnxn.kryobin"))
      ...
      val selfCnxn = new MockAgentCnxn("targetId".toURI, "", "sourceId".toURI)
      val selfCnxn1 = new MockAgentCnxn("targetId1".toURI, "", "sourceId1".toURI)
...
object KryoSerializerTestDataInitializer extends Specification
{
