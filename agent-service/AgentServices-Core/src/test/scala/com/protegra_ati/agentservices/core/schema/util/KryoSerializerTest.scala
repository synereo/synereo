...
//      // skipped("ignore")
//      val mockSimpleProfile = new Cloner().deepClone(profile1).asInstanceOf[ SimpleMockProfile1 ]
...
//      // skipped("ignore")
//      val compositeMockProfile = new Cloner().deepClone(compositeProfile).asInstanceOf[ CompositeMockProfile1 ]
